...
public class GraphPulseFragment extends Fragment {
    private GraphView graph;
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        return inflater.inflate(R.layout.fragment_graph_pulse, container, false);
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState){
        ...
        LineGraphSeries<DataPoint> series =
                ((LifeLine)this.getActivity().getApplication()).userActions.getPulseLineSeries();
        ...
        graph.getViewport().setMaxY
                (((LifeLine)this.getActivity().getApplication()).userActions.getMaxPulse()+10);
        graph.getViewport().setMinY
                (((LifeLine)this.getActivity().getApplication()).userActions.getMinPulse()-10);
    ...
    public void setReportGraph(){
        ...
        ArrayList<Pulse> arrayList = new ArrayList<>
                (((LifeLine)this.getActivity().getApplication()).userActions.getPulseArrayList());
        int average = normal.getAvPulse();
        Date date = new Date();
        Calendar buf = new GregorianCalendar();
        buf.setTime(date);
